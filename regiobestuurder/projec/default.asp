	...
	with rs
	   ...
	   %>
	    ...
	    do until .eof
	        %>
	        <tr>
	            <td style="background-color:<%=.fields("kleur") %>; padding: 5px 5px 5px 5px; border-bottom: solid 1px #c0c0c0; font-weight: 700"><a style="color: #000000" href="fase.asp?fases_id=<%=.fields("id") %>"><%=.fields("fasnaa") %></a></td>
	            <td style="background-color:<%=.fields("kleur") %>; padding: 5px 5px 5px 5px; border-bottom: solid 1px #c0c0c0; font-weight: 700; text-align: right"><a style="color: #000000" href="fase.asp?fases_id=<%=.fields("id") %>">>></a></td>
	        </tr>
	        <tr>
