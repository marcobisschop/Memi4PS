/***********************************************************
InnovaStudio WYSIWYG Editor 2.5
...
function InnovaEditor(oName)
	...
	this.buttonMap=["Save","FullScreen",
			"Cut","Copy","Paste","PasteWord","PasteText","|","Undo","Redo","|",
			"ForeColor","Hyperlink","Line",	"ClearAll","StyleAndFormatting","Styles","Bold","Italic","Underline","Strikethrough","Superscript","Subscript","JustifyLeft","JustifyCenter","JustifyRight","JustifyFull","|",
...
function RENDER(sPreloadHTML)
	...
	for(var i=0;i<this.buttonMap.length;i++)
		...
		switch(sButtonName)
			...
			case "|":
				...
				break;
			case "BRK":
				sHTMLIcons+="</td></tr></table><table class='editor' cellpadding=0 cellspacing=0><tr><td dir=ltr style='padding:0px'>";
				break;
			case "Save":
			...
			case "Preview":
				if(this.btnPreview)
					...
					sHTMLDropMenus+="<table class='editor' id=dropPreview"+this.oName+" cellpadding=0 cellspacing=0 "+
			...
			case "StyleAndFormatting":
				...
				if(this.btnTextFormatting||this.btnParagraphFormatting||this.btnListFormatting||this.btnBoxFormatting||this.btnCssText||this.btnCssBuilder)
					...
					sHTMLDropMenus+="<table class='editor' id=dropStyle"+this.oName+" cellpadding=0 cellspacing=0 "+
						"style='z-index:1;display:none;position:absolute;border:#80788D 1px solid;"+
						"cursor:default;background-color:#fbfbfd;' unselectable=on>"+
						sTmp+"</table>";
					}
			...
			case "Paragraph":
				if(this.btnParagraph)
					{
					sHTMLDropMenus+="<table class='editor' id=dropParagraph"+this.oName+" cellpadding=0 cellspacing=0 "+
						"style='z-index:1;display:none;position:absolute;border:#80788D 1px solid;"+
						"cursor:default;background-color:#fbfbfd;' unselectable=on>";
			...
			case "FontName":
				if(this.btnFontName)
					{
					sHTMLDropMenus+="<table class='editor' id=dropFontName"+this.oName+" cellpadding=0 cellspacing=0 "+
						"style='z-index:1;display:none;position:absolute;border:#80788D 1px solid;"+
					...
					sHTMLDropMenus+="<table class='editor' cellpadding=0 cellspacing=0>";
					for(var j=0;j<this.arrFontName.length;j++)
						{
						//if(this.arrFontName[j].length==1)
						if(this.arrFontName[j].toString().indexOf(",")==-1)						
			...
			case "FontSize":
				if(this.btnFontSize)
					{
					sHTMLDropMenus+="<table class='editor' id=dropFontSize"+this.oName+" cellpadding=0 cellspacing=0 "+
						"style='z-index:1;display:none;position:absolute;border:#80788D 1px solid;"+
						"cursor:default;background-color:#fbfbfd;' unselectable=on>";
			...
			case "CustomTag":
				if(this.btnCustomTag)
					{
					sHTMLDropMenus+="<table class='editor' id=dropCustomTag"+this.oName+" cellpadding=0 cellspacing=0 "+
						"style='z-index:1;display:none;position:absolute;border:#80788D 1px solid;"+
			...
			case "Table":
				if(this.btnTable)
					{
					sHTMLDropMenus+="<table class='editor' id=dropTable"+this.oName+" cellpadding=0 cellspacing=0 "+
							"style='z-index:1;display:none;position:absolute;border:#80788D 1px solid;"+
							"cursor:default;background-color:#fbfbfd;' unselectable=on>"+
					...
					sHTMLDropMenus+="<table class='editor' width=195 id=dropTableCreate"+this.oName+" onmouseout='doOut_TabCreate();event.cancelBubble=true' style='position:absolute;display:none;cursor:default;background:#f3f3f8;border:#8a867a 1px solid;' cellpadding=0 cellspacing=2 border=0 unselectable=on>";
					for(var m=0;m<8;m++)
						{
						sHTMLDropMenus+="<tr>";
						for(var n=0;n<8;n++)
			...
			case "Form":
				if(this.btnForm)
					...
					sHTMLDropMenus+="<table class='editor' id=dropForm"+this.oName+" cellpadding=0 cellspacing=0 "+
						"style='z-index:1;display:none;position:absolute;border:#80788D 1px solid;"+
						"cursor:default;background-color:#fbfbfd;' unselectable=on>";
			...
			case "Clean":
				if(this.btnClean)
					...
					sHTMLDropMenus+="<table class='editor' id=dropClean"+this.oName+" cellpadding=0 cellspacing=0 "+
						"style='z-index:1;display:none;position:absolute;border:#80788D 1px solid;"+
						"cursor:default;background-color:#fbfbfd;' unselectable=on>"+
	...
	sHTML+="<table class='editor' id=idArea"+this.oName+" name=idArea"+this.oName+" border=0 "+
			...
			"<table class='editor' cellpadding=0 cellspacing=0><tr><td dir=ltr style='padding:0px'>"+
			sHTMLIcons+
			"</td></tr></table>"+
			"</td></tr>"+
...
function drawColorPicker()
	...
	var sHTMLColor="<table class='editor' id=dropColor"+this.oRenderName+" style=\"z-index:1;display:none;position:absolute;border:#9b95a6 1px solid;cursor:default;background-color:#E9E8F2;padding:2px\" unselectable=on cellpadding=0 cellspacing=0 width=143 height=109><tr><td unselectable=on style='padding:0px;'>";
	sHTMLColor+="<table class='editor' align=center cellpadding=0 cellspacing=0 border=0 unselectable=on>";
	for(var i=0;i<arrColors.length;i++)
		...
		for(var j=0;j<arrColors[i].length;j++)
			sHTMLColor+="<td onclick=\""+this.oName+".color='"+arrColors[i][j]+"';"+this.oName+".onPickColor();"+this.oName+".currColor='"+arrColors[i][j]+"';"+this.oName+".hideAll()\" onmouseover=\"this.style.border='#777777 1px solid'\" onmouseout=\"this.style.border='#E9E8F2 1px solid'\" style=\"cursor:default;padding:1px;border:#E9E8F2 1px solid;\" unselectable=on>"+
				"<table class='editor' style='margin:0;width:13px;height:13px;background:"+arrColors[i][j]+";border:white 1px solid' cellpadding=0 cellspacing=0 unselectable=on>"+
	...
	sHTMLColor+= "<td unselectable=on style='padding:0px;'>"+
		"<table class='editor' style='margin-left:1px;width:14px;height:14px;background:#E9E8F2;' cellpadding=0 cellspacing=0 unselectable=on>"+
	...
	sHTMLColor+= "<td colspan=7 unselectable=on style='padding:0px;'>"+
		"<table class='editor' style='margin:1px;width:117px;height:16px;background:#E9E8F2;border:white 1px solid' cellpadding=0 cellspacing=0 unselectable=on>"+
...
function refreshCustomColor()
	...
	sHTML="<table class='editor' cellpadding=0 cellspacing=0 width=100%><tr><td colspan=8 style=\"font-family:verdana;font-size:9px;font-color:black;line-height:9px;padding:1\">"+this.txtCustomColors+":</td></tr></table>";
	sHTML+="<table class='editor' cellpadding=0 cellspacing=0><tr>";
	for(var i=0;i<this.customColors.length;i++)
		{
		if(i<22)
			{
			if(i==8||i==16||i==24||i==32)sHTML+="</tr></table><table class='editor' cellpadding=0 cellspacing=0><tr>";
			sHTML+="<td onclick=\""+this.oName+".color='"+this.customColors[i]+"';"+this.oName+".onPickColor()\" onmouseover=\"this.style.border='#777777 1px solid'\" onmouseout=\"this.style.border='#E9E8F2 1px solid'\" style=\"cursor:default;padding:1px;border:#E9E8F2 1px solid;\" unselectable=on>"+
				"	<table class='editor'  style='margin:0;width:13;height:13;background:"+this.customColors[i]+";border:white 1px solid' cellpadding=0 cellspacing=0 unselectable=on>"+
				"	<tr><td unselectable=on></td></tr>"+
				"	</table>"+
				"</td>";
			}
...
function openStyleSelect()
	...
	sHTML+="<table class='editor' style='margin:1px;margin-top:2px;margin-bottom:3px;width:14px;height:14px;background:#E9E8F2;' cellpadding=0 cellspacing=0 unselectable=on>"+
	...
	sHTML+="<div unselectable=on style='overflow:auto;height:"+h+"px;'><table class='editor' cellpadding=0 cellspacing=0 style='background:#fcfcfc;height:100%;'>";
...
function moveTagSelector()
	{
	var sTagSelTop="<table class='editor' unselectable=on ondblclick='"+this.oName+".moveTagSelector()' width='100%' cellpadding=0 cellspacing=0><tr style='background:#e9e8f2;font-family:arial;font-size:10px;color:black;'>"+
	...
	var sTagSelBottom="<table class='editor' unselectable=on ondblclick='"+this.oName+".moveTagSelector()' width='100%' cellpadding=0 cellspacing=0><tr style='background:#e4e3ed;font-family:arial;font-size:10px;color:black;'>"+
		"<td id=idElNavigate"+ this.oName +" style='padding:1px;width:100%' valign=top>&nbsp;</td>"+
		"<td align=right valign=top nowrap>"+
		"<span id=idElCommand"+ this.oName +" unselectable=on style='display:none;text-decoration:underline;cursor:hand;padding-right:5;' onclick='"+this.oName+".removeTag()'>"+getText("Remove Tag")+"</span>"+
		"</td></tr></table>";
...
function doClick_TabCreate()
	...
	var sHTML="<table class='editor' style='border-collapse:collapse;width:100%;'>";
...
function writeIconToggle(id,command,img,title)
	...
	sHTML=""+
		...
		"</span></span></td>";
	sHTML="<table class='editor' align=left cellpadding=0 cellspacing=0 style='table-layout:fixed;'><tr>"+sHTML+"</tr></table>";
