...
%>
<div class=rolodex>
    <a href="e_toetsresultaat.asp?viewstate=new&id=-1&students_id=<%=recordid %>&toetsen_type=p"><%=getlabel("new") %></a>
</div>
<%

	sql = "select * from vw_students_results where toetsen_type='p' and studenten_id =" & recordid 	
	...
	fields = fields & "$name:=codetot;type:=link;url:=e_toetsresultaat.asp?viewstate=edit&id=~id~&toetsen_type=p&students_id=~studenten_id~;$"
	orderby = "codetot"
