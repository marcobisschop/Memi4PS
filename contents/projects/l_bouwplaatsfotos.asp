...
<%
	...
	sql = "select id,arcbes,cast(arcsiz/1024 as varchar) + ' Kb' as arcsiz,volgor,available,'x'as del from dosarc where inreto='projec_bouwplaatsfotos' and inreto_id=" & recordid
	...
	if ispostback() and errorcount=0 then
	    if uploader.files.count = 1 then
	        ...
	        with rs
			    ...
			    .fields("inreto") = "projec_bouwplaatsfotos"
	...
	f_header "Selecteer een foto op uw computer en geef een volgorde en omschrijving op."
	f_form_hdr()
