...
<%
	...
	function save_rs(rs)
	   ...
	   ' response.end
		...
		if rs.fields("achter") = "new" then
	        sql = ""
	        sql = sql & " sp_relati_insert_deelnemer "
	        sql = sql & " ( "
		...
		<td valign="top">
			<table style="" ID="Table3">
				<%
					...
					'f_label rs, "stipp_key","stipp_key"
					'f_checkbox rs,"is_partner","is_partner"
					'f_label rs, "stipp_partnerid","stipp_partnerid"
				%>
			</table>
		</td>
	</tr>
