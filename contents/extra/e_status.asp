...
<%
	...
	if viewstate = "save" or viewstate = "savenew" then	
		if ispostback() then
			if not v_valid("^\w",true,fieldvalue(rs,"stanaa")) then v_addformerror "stanaa"
	...
	function save_rs(rs)
		with rs
			.fields("stanaa") = fieldvalue(rs,"stanaa")
			.fields("stabes") = fieldvalue(rs,"stabes")
	...
	<tr>
		<td valign="top">
			<table style="" ID="Table2">
				<%
					f_textbox rs,"stanaa","stanaa","300"
					f_textbox rs,"stabes","stabes","300"
