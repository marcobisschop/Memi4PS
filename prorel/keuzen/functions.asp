	...
	<table cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td valign=top align=right style="font-size:20px">
						    ...
						    if .fields("prikop") < 0 then
						        response.write "<span style='color: red'>" & formatvalue ("euro", .fields("prikop")) & "</span>"
						    else
						        response.write "<span style='color: blue'>" & formatvalue ("euro", .fields("prikop")) & "</span>"
						    end if
		...
		<tr>
			<td colspan=3 class="menu_bar">
			    ...
			    <a class="menu_option" href="e_docum.asp?viewstate=view&id=<%=id%>&inreto=keuzen&inreto_id=<%=id%>"><%=getlabel("docum")%></a>
