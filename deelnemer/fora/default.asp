...
Een forum wordt gebruikt om gezamenlijk over een onderwerp te discusseren en op 
        ...
        if not .eof then
            ...
            do until .eof
                if .fields("closed") then
                    myURL = "<a title='Gesloten' style='color: #ff0000' href='/deelnemer/fora/fora.asp?fora_id=" & .fields("id") & "'>" & .fields("name") & "</a> (Gesloten)"
                else
                    myURL = "<a href='/deelnemer/fora/fora.asp?fora_id=" & .fields("id") & "'>" & .fields("name") & "</a>"
                end if 
                %><li><%=myurl%></li><%
                .movenext
            loop 
